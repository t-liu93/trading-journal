...
| **F3** | [P8](./backend-expansion-plan.zh.md#p8--position) + [P10](./backend-expansion-plan.zh.md#p10--strategy-meta-extensions) + [P11](./backend-expansion-plan.zh.md#p11--tradeplan-event-stream) | Position 列表 + 创建/编辑 + 详情页（含 strategy-meta tabs 与 Plan tab） | ⏳ 下一步（P8/P10/P11 完成后） |
