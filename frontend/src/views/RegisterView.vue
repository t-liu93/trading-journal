...
async function handleSubmit(): Promise<void> {
  ...
  try {
    ...
    // Same credentials are already valid — log in straight away.
    ...
    if (err instanceof ApiError) {
      ...
      message.error('Registration failed: unexpected error.')
      throw err
    }
  } finally {
...
<template>
  <n-space vertical align="center" :size="24" style="padding: 4rem 1rem;">
    <n-h1 style="margin: 0;">Create account</n-h1>
    <n-card style="width: min(360px, 92vw);">
      ...
      <n-form @submit.prevent="handleSubmit">
        ...
        <n-text depth="3" style="font-size: 12px; display: block; margin: -0.5rem 0 0.75rem;">
